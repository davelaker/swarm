...
export const LATE_TASKS: Omit<Task, 'status'>[] = [
  ...
  {
    id: 't5',
    title: 'Security re-review of t4',
    assignee: 'security',
    deps: ['t4'],
    lane: 0,
    late: true,
...
export const RUN_SCRIPT: RunEvent[] = [
  ...
  { at: 2700, fn: 'agent', who: 'coder', step: 'Writing structured findings' },
  {
    ...
    task: 't1',
    verdict: 'complete',
    summary: 'Implemented LeaderboardCommand, 2 files changed',
  },
  ...
  { at: 6800, fn: 'agent', who: 'security', step: 'Confirming injection vector' },
  {
    ...
    task: 't3',
    verdict: 'changes',
    summary: 'SQL injection in season filter',
  },
  ...
  { at: 7700, fn: 'idle', who: 'security', verdict: 'changes' },
  {
    at: 8400,
    fn: 'pm',
    text: "Security flagged a SQL injection in the season filter (t3). I've created t4 to fix it and t5 to re-review. Coder is on it now.",
  },
  { at: 9100, fn: 'addtasks' },
  ...
  { at: 12000, fn: 'agent', who: 'coder', step: 'Writing findings' },
  {
    ...
    task: 't4',
    verdict: 'complete',
    summary: 'Parameterized query, prepared statement',
  },
  ...
  { at: 14200, fn: 'agent', who: 'security', step: 'Verifying parameterization' },
  {
    ...
    task: 't5',
    verdict: 'pass',
    summary: 'No injection vectors remain',
  },
  ...
  { at: 15100, fn: 'idle', who: 'security', verdict: 'pass' },
  {
    at: 15500,
    fn: 'pm',
    text: 'All gates are green. /leaderboard passed tests and the security re-review — ready to ship.',
  },
  { at: 15500, fn: 'finish' },
];
